...
-- Unified durable self-correction lifecycle
CREATE TABLE IF NOT EXISTS correction_cycles (
    id TEXT PRIMARY KEY,                         -- corr-<stable fingerprint>
    task_id TEXT NOT NULL,
    run_id TEXT DEFAULT '',
    subtask_id TEXT NOT NULL,
    ...
    reason_code TEXT DEFAULT '',
    blocker_snapshot TEXT NOT NULL,              -- JSON array
    baseline_progress TEXT NOT NULL,             -- JSON object
    latest_progress TEXT NOT NULL,               -- JSON object
    attempt_count INTEGER NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS correction_attempts (
    ...
    attempt INTEGER NOT NULL,
    state TEXT NOT NULL,
    plan_json TEXT NOT NULL,                     -- JSON object
    before_progress TEXT NOT NULL,               -- JSON object
    after_progress TEXT NOT NULL,                -- JSON object
