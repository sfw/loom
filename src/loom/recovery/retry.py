"""Retry manager with escalation ladder.

Implements structured retry and escalation for failed subtasks:
1. Same model + verification feedback
...
class RetryManager:
    """Manages retry logic with tier escalation.

    Escalation ladder:
    - Attempt 1: original tier, no retry context
    - Attempt 2: same tier + verification feedback
