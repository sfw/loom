...
class SemanticCompactor:
    ...
    _MAX_CHUNKS_PER_ROUND = 10
    _MAX_REDUCTION_ROUNDS = 2
    _MIN_COMPACT_TARGET_CHARS = 220
    _RESPONSE_TOKENS_FLOOR = 256
    _RESPONSE_TOKENS_RATIO = 0.55
    _RESPONSE_TOKENS_BUFFER = 256
    _JSON_HEADROOM_CHARS_FLOOR = 128
    _JSON_HEADROOM_CHARS_RATIO = 0.30
    _JSON_HEADROOM_CHARS_CAP = 1024
    _CHARS_PER_TOKEN_ESTIMATE = 2.8
    _TOKEN_HEADROOM = 128
    _TARGET_CHARS_RATIO = 0.82
