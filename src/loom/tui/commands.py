...
_COMMANDS = [
    ...
    ("Pause cowork chat", "pause_chat", "Request pause at next safe boundary"),
    ("Resume cowork chat", "resume_chat", "Resume cowork chat after pause"),
    ("Inject steering…", "inject_prompt", "Prefill /inject for queued steering"),
    ("Redirect cowork…", "redirect_prompt", "Prefill /redirect for immediate steering"),
    ("Show steering queue", "steer_queue", "Show queued cowork steering state"),
    ("Clear steering queue", "steer_clear", "Clear queued inject and pause state"),
