...
export default function FilesTab() {
  const {
    ...
    contextualDirectoryCounts: state.contextualDirectoryCounts,
    contextualFilePaths: state.contextualFilePaths,
    expandedWorkspaceDirectories: state.expandedWorkspaceDirectories,
    importingWorkspaceFiles: state.importingWorkspaceFiles,
    loadingWorkspaceDirectory: state.loadingWorkspaceDirectory,
    loadingWorkspaceFilePreview: state.loadingWorkspaceFilePreview,
    locallyVisibleWorkspaceFilePaths: state.locallyVisibleWorkspaceFilePaths,
    normalizedWorkspaceFileFilterQuery: state.normalizedWorkspaceFileFilterQuery,
    recentDirectoryCounts: state.recentDirectoryCounts,
    recentFilePaths: state.recentFilePaths,
    refreshingWorkspaceFiles: state.refreshingWorkspaceFiles,
    savingWorkspaceFile: state.savingWorkspaceFile,
    selectedWorkspaceFileEditorHasChanges: state.selectedWorkspaceFileEditorHasChanges,
    selectedWorkspaceFileEntry: state.selectedWorkspaceFileEntry,
    selectedWorkspaceFileIsEditable: state.selectedWorkspaceFileIsEditable,
    ...
    selectedWorkspaceFileEditHint: state.selectedWorkspaceFileEditHint,
    visibleRootWorkspaceFiles: state.visibleRootWorkspaceFiles,
    workspaceFileEditorDirty: state.workspaceFileEditorDirty,
    workspaceFileEditorDraft: state.workspaceFileEditorDraft,
    workspaceFileFilterQuery: state.workspaceFileFilterQuery,
    workspaceFileInputRef: state.workspaceFileInputRef,
    workspaceFilePreview: state.workspaceFilePreview,
    workspaceFileTreeMode: state.workspaceFileTreeMode,
    workspaceFilesByDirectory: state.workspaceFilesByDirectory,
    workspaceImportFolderDraft: state.workspaceImportFolderDraft,
  }), shallowEqual);
  const {
