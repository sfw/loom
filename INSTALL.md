...
**Note:** PDF, Word document (.docx), and PowerPoint (.pptx) support is included out of the box — `pypdf`, `python-docx`, and `python-pptx` are required dependencies, no extras needed.
